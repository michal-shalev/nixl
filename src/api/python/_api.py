...
@param etcd_watch_timeout_sec Timeout in seconds for etcd watch operations.
...
class nixl_agent_config:
    def __init__(
        ...
        self.etcd_watch_timeout_sec = etcd_watch_timeout_sec
